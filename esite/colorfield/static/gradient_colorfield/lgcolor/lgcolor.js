...
document.onreadystatechange = function(){
	...
	// append lgcolor html
    var elem = '<div class="lg-row lg-white" style="display:none;"> <div class="lg-col m12" id="main"> <div class="lg-container lg-padding-large" style="background-color:#f1f1f1;border:1px solid #d3d3d3;"> <div class="lg-row"> <div class="lg-col m6"> <div id="result01"></div><br></div><div class="lg-col m1">&nbsp;</div><div class="lg-col m5"> <div style="font-family:Consolas, \'courier new\';padding-bottom:8px;"> <input id="color1" class="jscolor{uppercase:false, hash:true}" type="text" class="lg-input lg-border lg-input1" value="#00f260" > <div style="height:5px"></div><input id="color2" class="jscolor{uppercase:false, hash:true}" type="text" class="lg-input lg-border lg-input2" value="#0575e6" > </div><div class="lg-col s3 directionbtn"><div id="dir1"></div></div><div class="lg-col s3 directionbtn"><div id="dir2"></div></div><div class="lg-col s3 directionbtn"><div id="dir3"></div></div><div class="lg-col s3 directionbtn"><div id="dir4"></div></div><div class="lg-col s3 directionbtn"><div id="dir5"></div></div><div class="lg-col s3 directionbtn"><div id="dir6"></div></div><div class="lg-col s3 directionbtn"><div id="dir7"></div></div><div class="lg-col s3 directionbtn"><div id="dir8"></div></div></div></div><div class="lg-row" style="height: 22px;margin: 15px 0;" ><div class="lg-col m2" style="font-family:Consolas, \'courier new\';"> <div id="touchbutton1" style="text-align:center;display:none;"> <button ontouchstart="touchslider(1, -1, event)" ontouchend="stoptouchslider()" onmousedown="touchslider(1, -1, event)" onmouseup="stoptouchslider()">&#10094;</button> <button ontouchstart="touchslider(1, 1, event)" ontouchend="stoptouchslider()" onmousedown="touchslider(1, 1, event)" onmouseup="stoptouchslider()">&#10095;</button> </div><input class="lg-input lg-border" type="number" id="pow1" value="0"><br class="lg-hide-medium lg-hide-large"></div><div class="lg-col m8" style="position:relative;"> <div id="shield"></div><div id="redtable"></div></div><div class="lg-col m2" style="font-family:Consolas, \'courier new\';"> <br class="lg-hide-medium lg-hide-large"> <input class="lg-input lg-border" type="number" id="pow2" value="100"> <div id="touchbutton2" style="display:none;text-align:center;"> <button ontouchstart="touchslider(2, -1, event)" ontouchend="stoptouchslider()" onmousedown="touchslider(2, -1, event)" onmouseup="stoptouchslider()">&#10094;</button> <button ontouchstart="touchslider(2, 1, event)" ontouchend="stoptouchslider()" onmousedown="touchslider(2, 1, event)" onmouseup="stoptouchslider()">&#10095;</button> </div></div></div><div class="lg-row"><div class="lg-col l12 m12 lg-center" style="font-family:Consolas, \'courier new\';"> <input type="hidden" id="gradientinput" name="gradientinput" value=""> <button class="lg-button lg-close">Close</button> <button class="lg-button lg-apply">Apply</button> <br class="lg-hide-medium lg-hide-large"></div></div></div></div></div>';
...
function drawRedTable() {
	...
	for(i = 0; i <= 100; i++) {
		x += "<td";
		x += " style='position:relative;padding:0;'><div class='pointer' id='redpointer" + i + "'><div>" + i + "</div><i class='fa fa-caret-down'></i></div></td>";
	}
	x += "</tr>";
	...
	for(i = 0; i <= 100; i++) {
		x += "<td";
		x += " style='position:relative;padding:0;'><div class='pointerup' id='redpointerup" + i + "'><div>" + i + "</div><i class='fa fa-caret-up'></i></div></td>";
	}
	x += "</tr>";
	x += "</table>";
...
document.getElementById('dir1').addEventListener('click', function(){setGradient('bottom')});
document.getElementById('dir2').addEventListener('click', function(){setGradient('right')});
document.getElementById('dir3').addEventListener('click', function(){setGradient('top left')});
document.getElementById('dir4').addEventListener('click', function(){setGradient('top right')});
document.getElementById('dir5').addEventListener('click', function(){setGradient('top')});
document.getElementById('dir6').addEventListener('click', function(){setGradient('left')});
document.getElementById('dir7').addEventListener('click', function(){setGradient('bottom left')});
document.getElementById('dir8').addEventListener('click', function(){setGradient('bottom right')});

document.getElementById('color1').addEventListener('change', function(){setGradient()});
document.getElementById('color2').addEventListener('change', function(){setGradient()});
document.getElementById('color1').addEventListener('keydown', function(){setGradient(event)});
document.getElementById('color2').addEventListener('keydown', function(){setGradient(event)});

document.getElementById('pow1').addEventListener('input', function(){setGradient()});
document.getElementById('pow2').addEventListener('input', function(){setGradient()});
document.getElementById('pow1').addEventListener('change', function(){setGradient()});
document.getElementById('pow2').addEventListener('change', function(){setGradient()});
