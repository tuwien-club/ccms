...
class DBIO:
    ...
    # meths
    @staticmethod
    def register(matrikelnummer:str, user_id:int, username:str, first_name:str, last_name:str, email:str, registration_token:str, add_res:bool=False) -> bool:
    ...
    def activate_member(registration_token:str, activate_res:bool=False) -> bool:
        ...
        wannabemember = Member.objects.filter(registration_token=registration_token).first()
        if (wannabemember):
